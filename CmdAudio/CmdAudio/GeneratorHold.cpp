...
void GeneratorHold::Supply(MachineState & machineState, SampleDataBuffer & rDataBuffer, int startSample)
{
    ...
    if (sourceBuffer && holdGenerator)
    {
        ...
        SampleDataBuffer resetDataBuffer( rDataBuffer.GetLength() );
